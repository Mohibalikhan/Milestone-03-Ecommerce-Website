...
const Page = ({ params }: { params: { products: string } }) => {
  ...
  const productImage = productImages[params.products] || product1;
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col sm:flex-row gap-6">
          ...
          <div className="sm:w-1/2 flex justify-center items-center p-4">
            <Image src={productImage} alt="Product Image" width={400} height={300} className="rounded-lg" />
          </div>
          ...
          <div className="sm:w-1/2 flex flex-col justify-start items-start p-4 space-y-4">
            ...
            <p className="text-sm text-gray-600"><span className="font-bold">Category:</span> {product.category}</p>
            <p className="text-sm text-gray-600"><span className="font-bold">Description:</span> {product.description}</p>
            <p className="text-xl font-semibold text-black"><span className="font-bold">Price:</span> ${product.price}</p>
